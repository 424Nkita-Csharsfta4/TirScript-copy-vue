<template class="container container-sm">
    <div class="tag-input container-sm" :class="{ 'with-count': showCount }">
      <input
        v-model="newTag"
        type="text"
        :list="id"
  ...
  .tag {
    background-color: rgba(134, 72, 189, 0.782);
    padding: 5px;
    border-radius: 4px;
    color: white;
    white-space: nowrap;
